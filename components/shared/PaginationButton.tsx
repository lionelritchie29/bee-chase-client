...
const PaginationButtons: ComponentType<ComponentProps<'section'> & IPaginationButtons> = ({
  paginationKey,
  currentPage,
  length,
  ...rest
    ...
    <>
      ...
      <section className='hidden justify-end sm:flex' {...rest}>
        <section className='btn-group'>
          <button onClick={() => onChangePage(1)} disabled={!hasPrev} className='btn btn-secondary'>
